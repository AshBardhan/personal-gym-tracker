...
const Badge = ({ children, onRemove, className }: BadgeProps) => {
  return (
    <span
      className={clsx(
        "inline-flex items-center gap-1 rounded-full border border-gray-300 bg-white px-3 py-1 text-sm text-gray-800 dark:border-white dark:bg-neutral-900 dark:text-gray-100",
        className,
      )}
    >
      {children}
